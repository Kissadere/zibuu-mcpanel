                    ...
                    <div class="body">
                      <?php
                        if(isset($_POST['action'])) {
                          ...
                          $sql = "SELECT * FROM `core_badges` WHERE `id` = $identification";
                        ...
                        // Generating content
                        $badgeapi   = "http://habboo-a.akamaihd.net/c_images/album1584/$code.gif";
                        $badgetag   = "<img src='$badgeapi'</img>";

                      ?>
                      <div class="header">
                        <center><? echo $badgetag; ?></center>
                      </div>
                      <form method="post" name="ufid_updateachievement" id="ufid_updateachievement" action="handler/update-achievement.php" enctype="utf-8" autocomplete="off">
                        <!-- Form identification -->
                        <input type="hidden" name="form_name" id="form_name" value="ufid_updateachievement">
                        <input type="hidden" name="id" value="<? echo $identification; ?>">
                        <div class="body">
                              ...
                              <option value="Connections">Connections</option>
                                ...
                                <div class="form-group">
                                  ...
                                  <select name="entity_type" class="form-control">
                                    <optgroup label="Currently selected">
                                      <option value="<?php echo $entitytype; ?>"><?php echo $entitytype; ?></option>
                                    </optgroup>
                                      <optgroup label="Options">
                                    <option value="false">None</option>
                                      </optgroup>
                                ...
                                <div class="form-group">
                                  <label>Goal</label>
                                  <input class="form-control" type="number" name="goal" value="<? echo $goal; ?>" placeholder="100" maxlength="10" required>
                                </div>

                                <div class="form-group">
                                  <label>Title</label>
                                  <input class="form-control" type="text" name="title" value="<? echo $title; ?>" placeholder="My achievement" maxlength="75" required>
                                </div>
                                <div class="form-group">
                                  <label>Description</label>
                                  <input class="form-control" type="text" name="description" value="<? echo $description; ?>" placeholder="Gotta craft them all" maxlength="120" required>
                                </div>
                                <div class="form-group">
                                  <label>Codename</label>
                                  <input class="form-control" type="text" name="code" value="<? echo $code; ?>" placeholder="AC130" maxlength="25" required>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <select name="reward_type" class="form-control" required>
                                    <optgroup label="Currently selected">
                                      <option value="<?php echo $reward_type; ?>"><?php echo $reward_type; ?></option>
                                    </optgroup>
                                      <optgroup label="Options">
                                ...
                                <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" name="reward" value="<? echo $reward; ?>" placeholder="30" maxlength="75">
                                </div>
